...
def get_local_module_location(
    ...
    if file1.exists() and file2.exists():
        ...
        # ToDo: handle having a file and a package with the same name (probably just raise). Implement it elsewhere
    if file1.exists():
...
def get_module_info(
    ...
    if root_module != "":
        ...
        if root_module in sys.stdlib_module_names and get_other_module_location(module_name) is not None:
